...
const type = [
	{ id: 1, name: "Feature", unavailable: false },
	{ id: 2, name: "Story", unavailable: false },
	{ id: 3, name: "Incident", unavailable: false },
	{ id: 4, name: "Bug", unavailable: false },
];

export default function TypeListBox() {
